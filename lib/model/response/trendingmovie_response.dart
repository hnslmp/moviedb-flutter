...
TrendingMovieResponse trendingMovieResponseFromJson(String str) =>
    TrendingMovieResponse.fromJson(json.decode(str));

String trendingMovieResponseToJson(TrendingMovieResponse data) =>
...
enum OriginalLanguage { EN, NO, ES, NL }
